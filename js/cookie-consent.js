(function () {
  ...
  /* Keskeny (mobil) képernyőn kisebb helyet foglalnak a gombok, hogy
     nagyobb eséllyel kiférjen mindhárom egy sorban; ha mégsem fér ki,
     a fenti max-width/flex-wrap szabályok miatt szépen tördelődnek,
     nem lógnak ki a képernyőről. */
  @media (max-width: 480px) {
    .ccb-banner { padding: 10px 12px; }
    .ccb-buttons { gap: 6px; }
    .ccb-btn { padding: 7px 10px; font-size: 12.5px; }
  }
  `;
  ...
  function init() {
    ...
    // Fejlesztői/teszt segédfüggvény: törli a mentett döntést és újratölti
    // az oldalt, hogy a bannert elölről ki lehessen próbálni.
    // Használat a böngésző konzoljában: resetCookieConsent()
